...
const SplashScreenComponent = () => {
  ...
  useEffect(() => {
    ...
    const timeout = setTimeout(() => {
      (navigation as any).navigation.navigate("login"); // Replace Splash screen with Home
    }, 6000);
  ...
  return (
    <View style={styles.container}>
      ...
      <Animated.View style={animatedStyle}>
        ...
        <Text style={styles.text}>Welcome Citizens of PNG.</Text>
        <Text style={styles.text}>Be Counted</Text>
        <Text style={styles.emoji}>✨🎉</Text>
      </Animated.View>
    </View>
  );
...
const styles = StyleSheet.create({
  container: {
    flex: 1,
    backgroundColor: "#232372FF", // White background color for a modern splash
